...
class PembelianController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $rs = MasterRs::get();
        return view('pembelian.index', compact('rs'));
    }
    ...
    public function excel_pembelian(Request $request)
    {
        ...
        $nama_file = 'laporan Pembelian' . $request->input('tgl_mulai') . ' - Hingga - ' . $request->input('tgl_akhir') . '.xlsx';
        return Excel::download(new PembelianExport($tgl_mulai, $tgl_akhir, $unit, $rs), $nama_file);
    }
}
