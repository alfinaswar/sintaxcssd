...
@section('content')
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        <form method="post" action="{{ route('flipbook.store') }}" id="cetak-laporan">
                            @csrf
                            <div class="row col-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="UserGroupID" class="col-form-label">Nama File Flipbook</label>
                                        <div class="form-group row">
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <input type="text" class="form-control" placeholder="Nama File" name="NamaFile" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="UserGroupID" class="col-form-label">Merk</label>
                                        <div class="form-group row">
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="UserGroupID" class="col-form-label">Tahun Pembelian</label>
                                        <div class="form-group row">
                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                <select class="form-control" id="tahun" name="TahunPembelian">
