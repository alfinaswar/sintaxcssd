...
@section('content')
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" id="simpanForm" action="{{ route('manualbook.store') }}" method="POST"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control" name="Nama" value="{{ old('Nama') }}" placeholder="Nama Alat"
                                    type="text" id="nama">
                            </div>
                        </div>
                        <div class="form-group row">
