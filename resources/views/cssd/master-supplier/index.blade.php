            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('cssd-master-supplier.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
@push('js')
    ...
    <script>
            ...
            table.DataTable({
                ...
                ajax: "{{ route('cssd-master-supplier.index') }}",
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
        ...
        var delete_data = function (e, id) {
            e.preventDefault()
            var url = "{{ route('cssd-master-supplier.destroy', 'id') }}"
