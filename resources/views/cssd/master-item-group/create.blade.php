...
@section('content')
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" id="formGroupCSSD" action="{{ route('master-cssd.item-group.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input class="form-control {{ $errors->has('Nama') ? 'is-invalid' : '' }}" name="Nama"
                                    value="{{ old('Nama') }}" placeholder="Masukkan Nama Item Group" type="text" id="nama">
                                @if ($errors->has('Nama'))
