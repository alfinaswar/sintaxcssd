...
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" id="simpanFrom"
            action="{{ route('cssd-master-merk.update', $data->id) }}" method="POST" accept-charset="utf-8"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="nama" class="col-2 col-form-label">Merk</label>
                            <div class="col-10">
                                <input class="form-control" name="Merk" value="{{ $data->Merk }}" placeholder="Nama Merk"
