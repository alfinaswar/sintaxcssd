...
<table width="100%">
    ...
    @foreach ($pembelian as $key => $item)
        <tr>
            ...
            <td width="475px" style="font-family: 'Times New Roman', Times, serif; text-align:left;">
                {{ $item->Nama }}</td>
            <td width="125px" style="font-family: 'Times New Roman', Times, serif;">Rp.
                {{ number_format($item->Harga, 0, ',', '.') }}</td>
            <td width="75px" style="font-family: 'Times New Roman', Times, serif; text-align:left;">
                {{ $item->JumlahDiterima }}</td>
        </tr>
    @endforeach
</table>
<style>
