            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text"><i
                                        class="fa fa-warehouse"></i></span></div>
                            <select class="custom-select form-control" id="filter_gudang" name="filter_gudang">
    ...
    <script>
        var dataTable = function() {
            ...
            table.DataTable({
                ...
                ajax: {
                    url: "{{ route('inventaris.index-gudang') }}",
                    data: function(d) {
                        d.filter_pengguna = $('#filter_pengguna').val(),
                            ...
                            d.filter_gudang = $('#filter_gudang').val(),
        ...
        $('#filter_pengguna,#filter_rs,#filter_departemen,#filter_unit,#unit,#filter_pembelian,#filter_gudang').change(function() {
