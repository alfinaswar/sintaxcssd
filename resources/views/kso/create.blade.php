        ...
        <div class="kt-portlet__body">
            <div class="tab-content">
                <div class="tab-pane active" id="kt_portlet_base_demo_3_3_tab_content" role="tabpanel">
                    <form class="kt-form kt-form--label-right" id="form-kso" action="{{ route('kso.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <input class="form-control" name="Type" value="{{ old('Type') }}"
                                                placeholder="Tipe Alat" type="text" id="Type">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Merk</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                            <input class="form-control" name="Merk" value="{{ old('Merk') }}"
                                                placeholder="Serial Number" type="text" id="Merk">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" name="Sn" value="{{ old('no_sn') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" name="NamaPerusahaan"
                                                value="{{ old('NamaPerusahaan') }}" placeholder="Tanggal beli"
                                                type="text" id="NamaPerusahaan">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" name="TanggalKerjaSama"
                                                value="{{ old('TanggalKerjasama') }}" placeholder="Tanggal beli"
                                                type="date" id="TanggalKerjasama">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" name="DueDateKerjaSama"
                                                value="{{ old('DueDateKerjaSama') }}" placeholder="Tanggal beli"
                                                type="date" id="DueDateKerjaSama">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="Jumlah" class="col-3 col-form-label">Jumlah</label>
                                        <div class="col-lg-9">
                                            <input class="form-control" name="Jumlah" value="{{ old('Jumlah') }}"
                                                placeholder="Jumlah" type="number" id="Jumlah">
                                        </div>
                                    </div>
                                    <div class="form-group row">
