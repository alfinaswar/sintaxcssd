...
@section('content')
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" id="simpanFrom" action="{{ route('master-rs.update', $data->id) }}"
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                ...
                                <input class="form-control" name="kodeRs" value="{{ $data->kodeRS }}"
                                    placeholder="Nama Perangkat" type="text" value="" id="kodeRs" readonly>
                            </div>
                        </div>
