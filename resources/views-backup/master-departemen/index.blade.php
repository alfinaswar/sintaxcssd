        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    <a href="{{ route('master-departemen.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
<script>
    var dataTable = function() {
            ...
            table.DataTable({
                ...
                ajax: "{{ route('master-departemen.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        var delete_data = function(e, id) {
            e.preventDefault()
            var url = "{{ route('master-departemen.destroy', 'id') }}"
            url = url.replace('id', id)

            swal.fire({
                title: 'kamu yakin?',
                text: "Kamu akan menghapus data departemen ini!",
                type: 'warning',
